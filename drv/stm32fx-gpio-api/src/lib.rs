...
//! Client API for the STM32Fx GPIO server.
...
/// Enumeration of all GPIO ports on the STM32fx series. Note that not all these
...
/// The STM32Fx GPIO hardware lets us configure up to 16 pins on the same port
