...
fn gpio_reg(port: Port) -> &'static device::gpioa::RegisterBlock {
    match port {
        ...
        Port::B => unsafe { &*(device::GPIOB::ptr() as *const device::gpioa::RegisterBlock) },
        Port::C => unsafe { &*(device::GPIOC::ptr() as *const device::gpioa::RegisterBlock) },
        Port::D => unsafe { &*(device::GPIOD::ptr() as *const device::gpioa::RegisterBlock) },
        Port::E => unsafe { &*(device::GPIOE::ptr() as *const device::gpioa::RegisterBlock) },
        Port::F => unsafe { &*(device::GPIOF::ptr() as *const device::gpioa::RegisterBlock) },
        Port::G => unsafe { &*(device::GPIOG::ptr() as *const device::gpioa::RegisterBlock) },
        Port::H => unsafe { &*(device::GPIOH::ptr() as *const device::gpioa::RegisterBlock) },
        Port::I => unsafe { &*(device::GPIOI::ptr() as *const device::gpioa::RegisterBlock) },
        Port::J => unsafe { &*(device::GPIOJ::ptr() as *const device::gpioa::RegisterBlock) },
        Port::K => unsafe { &*(device::GPIOK::ptr() as *const device::gpioa::RegisterBlock) },
    }
}
